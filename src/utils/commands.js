...
let commandList = [
	...
	},
	{
		...
		action: true,
		response:
			'Visit: <a href="https://github.com/renezzero/">my github @renezzero</a>',
		subPathStrict: [false],
	...
	},
	{
		...
		action: true,
		response:
			'Visit: <a href="https://www.linkedin.com/in/george-tasioulis-a11593223/">LinkedIn</a>',
		subPathStrict: [false],
		description: "checkout linkedIn profile",
	},
	{
		...
		action: false,
		response:
			'Page Under Development 🚧🔨 | Until then Visit: <a href="https://github.com/renezzero/">"github" to checkout my projects</a>',
		subPathStrict: [false],
	...
	},
	{
		...
		action: true,
		response:
			"Hi there! My name is George Tasioulis and I am a driven and passionate Software Engineer with a strong foundation in programming languages such as Java, Javascript,Rust and Python. I have also gained valuable experience in cloud computing and DevOps, specifically using tools and technologies like Docker and Kubernetes. I am deeply interested in web development and software applications, and have had the opportunity to work on a number of real-life projects that have allowed me to apply my skills and problem-solving abilities. In my free time, you can find me on my GitHub profile, https://github.com/renezzero/, where I started contribute recently and collaborate on various open source projects. I am always seeking to learn and grow as a developer, and am excited to see where my interests and skills in cloud computing and DevOps will take me in the future. I am eager to apply my knowledge and abilities to meaningful projects and make a positive impact in the tech industry.",
		subPathStrict: [false],
...
const fileList = [
	{
		name: ".github",
		link: "https://github.com/renezzero/",
		folder: true,
		executable: false,
	},
	{
